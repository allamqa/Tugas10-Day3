...
<body>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_GET['id_produk'])){
			...
			$select = mysqli_query($koneksi, "SELECT * FROM produk WHERE id='$id_produk'") or die(mysqli_error($koneksi));
		...
		if(isset($_POST['submit'])){
          ...
          $sql = mysqli_query($koneksi, "INSERT INTO produk SET nama_produk='$nama_produk', keterangan='$keterangan', harga='$harga', jumlah='$jumlah'") or die(mysqli_error($koneksi));
